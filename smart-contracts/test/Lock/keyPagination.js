  ...
  describe('getKeysByPage', () => {
    ...
    it('should return the requested keys', () => {
      ...
      return locks['FIRST'].purchaseFor(accounts[0], Web3Utils.fromAscii('Julien'), {
        ...
        .then((results) => {
          const returnedTimeStamps = results[0].map(t => t.toNumber(10))
          const returnedDataHashes = results[1].map(h => Web3Utils.toUtf8(h))
          console.log(returnedTimeStamps)
          console.log(returnedDataHashes)
